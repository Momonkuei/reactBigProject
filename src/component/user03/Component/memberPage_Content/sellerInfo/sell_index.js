            ...
            <BrowserRouter>
                <div className="container mt-5">
                    <nav aria-label="Page navigation" className=" border-bottom">
                        <ul className="pagination  nav-fill  bg-project">
                            <li className="nav-item ">
                                <NavLink className="nav-link page-link" to="/VGT/memberPage/sellerInfo/tradeManage">我的商品</NavLink>
                            </li>                           
                    ...
                    <Switch>
                        ...
                        <Route path="/VGT/memberPage/sellerInfo/tradeManage" component={TradeManage}></Route>
