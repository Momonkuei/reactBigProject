...
class BasicInfo extends Component {
    ...
    componentDidMount () {
        ...
        // this.getid();
        // this.state.memberData.vgtid = this.state.vgtid;
        // this.setState({});
        // this.getID();
        this.getData();
    }
    ...
    getData = () => {
        ...
        var vgtid = 35;
        // console.log(vgtid)
        axios.get(`http://localhost:3000/Vgt/vgtserver/member/${vgtid}`)
             .then((res) => {                
    ...
    render() { 
        ...
        var trueid = memberData.trueid.replace(memberData.trueid.substr(2,3), "***");
        var lasttrueid = trueid.replace(trueid.substr(7,2), "**");
        // console.log(memberData.trueid);
        console.log(this.state.vgtid);
        return (
            <div className="row container d-flex flex-row mt-3">
                <div className="col-8 mt-4 border-right border-primary">
                    <form id="memberDataForm" name="memberDataForm" >                     
                        ...
                        <div className="d-flex flex-row mb-4">
                            <div className="text-muted fs-5 me-3">VGT餘額：</div>
                            <div className="fs-5 "> 
                                {memberData.vgtpoint}元                                                       
                            </div>
                        </div>
                        <div className="d-flex flex-row mb-4">   
                        ...
                        <div className="d-flex flex-row mb-4">   
                            ...
                            <div>
                                <input value={memberData.vgtname} onChange={ this.memberNamechange} onBlur={this.memberNameBlur}
                                       id="memberName" className="form-control form-control-sm text-center w-75" type="text" placeholder="請輸入暱稱" required />                            
                            </div>
                        ...
                        <div className="d-flex flex-row mb-4">
                            ...
                            <div>
                                ...
                                id="memberPhone" className="form-control form-control-sm text-center w-75" placeholder="請輸入電話號碼" required/>                                 
                            </div>
                        ...
                        <div className="d-flex flex-row mb-4 me-3">
                            ...
                            <div>
                                ...
                                id="memberMail" className="form-control form-control-sm text-center ms-3" style={{ width:"255px" }} type="email" placeholder="請輸入信箱" required/>
                            </div>
