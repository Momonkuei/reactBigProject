...
class Login extends Component {
    ...
    componentDidMount() {
        ...
        axios.get("http://localhost:3000/Vgt/login").then((response) => {
    ...
    submitNewLogin = (e) => {
        e.preventDefault();
        axios.post("http://localhost:3000/Vgt/login", {
            ...
            if (response.data[0].auth == 1) {
                ...
                window.location.href = 'http://localhost:8000/vgt/vgtPages';
        }});
    };
        ...
        return (
            <BrowserRouter>
                <div className="container">
                    <form className="form-horizontal col-sm-offset-3 col-md-offset-3" id="loginForm" method="POST" action="http://localhost:3000/Vgt/login" onSubmit={this.submitNewLogin}>
