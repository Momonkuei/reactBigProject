...
class Register extends Component {
    ...
    submitNewRegister = (e) => {
        e.preventDefault();
        axios.post('http://localhost:3000/Vgt/register', {
            ...
            <div className="container">
                ...
                <div className="container row">
                    <div className="form col-md-6">
                        <form className="form-horizontal" novalidate id="registerForm" method="POST" action="http://localhost:3000/Vgt/register" onSubmit={this.submitNewRegister}>
                            ...
                            <div className="form-group text-center agreeCheckbox"><br />
                                <label htmlhtmlFor="agree" className="agreeLabel myText">
                                    {/* <input name="agree" id="agree" type="checkbox" onChange={this.newRegister} /> */}
                                    註冊即表示同意&nbsp;
