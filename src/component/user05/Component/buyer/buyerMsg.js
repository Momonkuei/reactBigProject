...
import BuyerInsertMsg from './buyerInsertMsg';
...
class BuyerMsg extends Component {
    ...
    componentDidMount() {
        ...
        axios.get(`http://localhost:3000/Vgt/memberPage/buyer/tradereceive/${this.props.orderid}/cmmt`)
            .then(
                (response) => {
        ...
        return (
            <div className="mt-5 container border border-dark w-75" style={{ height: 'auto' }}>
                ...
                <div className="mt-5 container">
                    ...
                    <BuyerInsertMsg orderid={this.props.orderid}/>
                </div>
            </div>
        );
    }
